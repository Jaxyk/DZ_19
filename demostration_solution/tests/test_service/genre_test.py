...
def genre_dao():
    ...
    genre_dao.get_all = MagicMock(return_value=[action, thriller, comedy])
    genre_dao.create = MagicMock(return_value=Genre(id=3, name='fantasy'))
